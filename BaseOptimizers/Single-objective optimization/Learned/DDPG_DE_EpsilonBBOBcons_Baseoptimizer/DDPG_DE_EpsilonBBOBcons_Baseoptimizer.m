classdef DDPG_DE_EpsilonBBOBcons_Baseoptimizer < BASEOPTIMIZER
...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function [reward, nextState, done, bestPop] = update(this,BOparameters,Problem)
            ...
            replace             = FitnessWithAdaptiveEpsilonCHT(this.Population,BOparameters) > FitnessWithAdaptiveEpsilonCHT(Offspring,BOparameters);
