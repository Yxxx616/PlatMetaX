% MATLAB Code
function [offspring] = updateFunc123(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    ...
    % Calculate combined weights (higher weight = better solution)
    ...
    % Boundary control with quality-based reflection
    ...
    reflect_factor = 0.2 + 0.6 * repmat(weights, 1, D);
