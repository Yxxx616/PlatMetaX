% MATLAB Code
function [offspring] = updateFunc1370(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    lb = -100 * ones(1, D);
    ub = 100 * ones(1, D);
    ...
    % Adaptive weights
    alpha_feas = 1 - cv_norm;
    alpha_elite = 1 - f_norm;
    alpha_div = 1 + f_norm;
    denom = alpha_feas + alpha_elite + alpha_div + eps;
    w_feas = alpha_feas ./ denom;
    w_elite = alpha_elite ./ denom;
    w_div = alpha_div ./ denom;
