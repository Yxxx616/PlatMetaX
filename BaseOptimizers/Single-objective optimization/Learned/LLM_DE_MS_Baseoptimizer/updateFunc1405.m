% MATLAB Code
function [offspring] = updateFunc1405(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    lb = -100 * ones(1, D);
    ub = 100 * ones(1, D);
    ...
    for j = 1:D
        ...
        % Reflection with adaptive magnitude
        reflect_factor = 0.1 + 0.3 * rand(NP,1);
