% MATLAB Code
function [offspring] = updateFunc175(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    ...
    beta = 0.4 * c_weights / (c_sum + eps); % Normalized constraint weight
    gamma = 0.4 * w_f / (w_sum + eps); % Normalized fitness weight
