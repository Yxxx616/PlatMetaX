% MATLAB Code
function [offspring] = updateFunc1753(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    lb = -100 * ones(1, D);
    ub = 100 * ones(1, D);
    ...
    offspring(lower_violation) = lb_rep(lower_violation) + ...
        abs(offspring(lower_violation) - lb_rep(lower_violation));
    offspring(upper_violation) = ub_rep(upper_violation) - ...
        abs(offspring(upper_violation) - ub_rep(upper_violation));
