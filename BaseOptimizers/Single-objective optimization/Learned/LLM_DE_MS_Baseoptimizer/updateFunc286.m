% MATLAB Code
function [offspring] = updateFunc286(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    ...
    F = 0.5 + 0.3*sin(2*pi*rand(NP,1)); % Cyclic scaling factor
