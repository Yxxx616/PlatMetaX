% MATLAB Code
function [offspring] = updateFunc294(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    ...
    w_total = 0.5*exp_cons + 0.6*exp_fits + 0.1 + eps;
    
    w1 = (0.5*exp_cons + 0.2*exp_fits) ./ w_total;
    w2 = (0.3*exp_cons + 0.4*exp_fits) ./ w_total;
    w3 = 0.1 ./ w_total;
    w4 = (0.2*exp_cons + 0.3*exp_fits) ./ w_total;
