% MATLAB Code
function [offspring] = updateFunc299(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    ...
    w_total = exp_cons + exp_fits + 0.2 + eps;
    
    w1 = (0.5*exp_cons + 0.5*exp_fits) ./ w_total;
    w2 = (0.3*exp_cons + 0.3*exp_fits) ./ w_total;
    w3 = 0.1 ./ w_total;
    w4 = (0.1*exp_cons + 0.1*exp_fits) ./ w_total;
