% MATLAB Code
function [offspring] = updateFunc312(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    ...
    w_cons = exp(-norm_cons/sigma_c);
    w_rand = 1 - w_elite;
    
    % Normalize weights
    w_total = w_elite + w_rand + w_cons + eps;
    ...
    % Ensure diversity for top 20% solutions
