% MATLAB Code
function [offspring] = updateFunc334(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    ...
    % Elite selection (best fitness among feasible)
    ...
    % Best feasible individual (least constraint violation)
    if any(feasible_mask)
