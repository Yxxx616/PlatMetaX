% MATLAB Code
function [offspring] = updateFunc658(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    lb = -100 * ones(1, D);
    ub = 100 * ones(1, D);
    ...
    mutant = popdecs + ...
        ...
        F3.*(popdecs(r1,:) - popdecs(r2,:) + popdecs(r3,:) - popdecs(r4,:)) + ...
        F4.*(popdecs(r5,:) - popdecs(r6,:)).*(1 + cons./(sigma_cv + eps));
