% MATLAB Code
function [offspring] = updateFunc661(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    lb = -100 * ones(1, D);
    ub = 100 * ones(1, D);
    ...
    % 2. Calculate ranks based on constrained fitness
    ...
    % 7. Boundary handling with reflection and randomization
