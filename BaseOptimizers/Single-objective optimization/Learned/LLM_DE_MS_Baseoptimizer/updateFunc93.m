% MATLAB Code
function [offspring] = updateFunc93(popdecs, popfits, cons)
    [NP, D] = size(popdecs);
    ...
    % Calculate combined weights (70% fitness, 30% constraints)
    weights = 0.7 * (1 - norm_fits) + 0.3 * (1 - norm_cons);
