classdef DDPG_NSGAII_Alpha_Environment < rl.env.MATLABEnvironment
    ...
    methods
        function this = DDPG_NSGAII_Alpha_Environment(ps,bo,task)
            % Initialize observation settings  /population state
            ObservationInfo = rlNumericSpec([14 1]);
            ObservationInfo.Name = 'observations';
            ObservationInfo.Description = 'nf,qf,n,m,b,v,c,x...';

            % Initialize BOparameters settings    /
            % parameter-Alpha of base-optimizer-NSGAII for constrained
            % multiobjective optimization
            ActionInfo = rlNumericSpec([1 1],'LowerLimit',0,'UpperLimit',1);
            ActionInfo.Name = 'BOparameters';
            ActionInfo.Description = 'CHT EPSILON PARAMETER ONLINE TUNING';
