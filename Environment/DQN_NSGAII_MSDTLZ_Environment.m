classdef DQN_NSGAII_MSDTLZ_Environment < rl.env.MATLABEnvironment
%------------------------------- Copyright --------------------------------
...
%--------------------------------------------------------------------------
    ...
    methods
        function this = DQN_NSGAII_MSDTLZ_Environment(ps,bo,task)
            ...
            ActionInfo.Description = 'NSGAII-Mutation strategy selection';
        ...
        function InitialObservation = reset(this)
            ...
            InitialObservation = this.baseoptimizer.calMOPstate();
