classdef TF_DE_Sol_Environment < rl.env.MATLABEnvironment
%------------------------------- Copyright --------------------------------
...
%--------------------------------------------------------------------------
    ...
    methods
        function obj = TF_DE_Sol_Environment(ps, bo, task)
            % 初始化观测和动作空间
            maxTreeDepth = 3;
            problem = ps{1};
            ObservationInfo = rlNumericSpec([problem.D+2 1 100]);
            ActionInfo = rlNumericSpec([problem.D 1 100],...
