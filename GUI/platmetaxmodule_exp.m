...
%--------------------------------------------------------------------------
    ...
    methods(Access = ?platmetaxGUI)
        ...
        function obj = platmetaxmodule_exp(platmetaxGUI)
            ...
            obj.app.editA(2)   = platmetaxGUI.APP(17,3,uieditfield(obj.app.grid(1),'numeric','Value',1,'limits',[1 inf],'RoundFractionalValues','on','Tooltip','Number of populations saved in each run'));
