...
%--------------------------------------------------------------------------
    ...
    methods(Access = ?platmetaxGUI)
        ...
        function obj = platmetaxmodule_test(platmetaxGUI)
            ...
            obj.app.maingrid = platmetaxGUI.APP(3,1,uigridlayout(obj.platmetaxGUI.app.maingrid,'RowHeight',{20,'1x'},'ColumnWidth',{'1.2x',1,'1x',1,'2x','0.8x','0.2x',1,'1x'},'Padding',[0 5 0 5],'RowSpacing',5,'ColumnSpacing',0,'BackgroundColor','w'));
            ...
            obj.app.label(3) = platmetaxGUI.APP(1,[5 7],uilabel(obj.app.maingrid,'Text','Result display','HorizontalAlignment','center','FontSize',11,'FontColor',[.5 .5 .5]));
            obj.app.label(4) = platmetaxGUI.APP(1,9,uilabel(obj.app.maingrid,'Text','Result selection','HorizontalAlignment','center','FontSize',11,'FontColor',[.5 .5 .5]));
            ...
            platmetaxGUI.APP([1 2],8,uipanel(obj.app.maingrid,'BackgroundColor',[.8 .8 .8]));

            % The first panel
            obj.app.grid(1)   = platmetaxGUI.APP(2,1,uigridlayout(obj.app.maingrid,'RowHeight',{16,21,16,21,21,16,21,21,21,4,18,'1x',4,18,'1x'},'ColumnWidth',{'1x','1.1x','1x'},'Padding',[8 10 8 0],'RowSpacing',3,'ColumnSpacing',5,'BackgroundColor','w'));
            [obj.app.stateA,obj.app.labelA] = platmetaxGUI.GenerateLabelButton(obj.app.grid(1),[0,1,0,1,zeros(1,13)],@obj.cb_filter);
            obj.app.labelA(4) = platmetaxGUI.APP(11,[1 2],uilabel(obj.app.grid(1),'Text','Algorithms','FontSize',13,'FontColor',[.2 .4 .7],'FontWeight','bold'));
            ...
            obj.app.listA(1).ValueChangedFcn = @(~,~)platmetaxGUI.UpdateAlgProPara(obj.platmetaxGUI.app.figure,obj.app.listA(1),obj.app.listB,'BASEOPTIMIZER',1);
            obj.app.listA(2).ValueChangedFcn = @(~,~)platmetaxGUI.UpdateAlgProPara(obj.platmetaxGUI.app.figure,obj.app.listA(2),obj.app.listB,'PROBLEM',-1);

            % The third panel
            obj.app.dropC(1) = platmetaxGUI.APP(1,6,uidropdown(obj.app.maingrid,'BackgroundColor','w','Items',{},'ValueChangedFcn',@obj.cb_slider));
            obj.app.dropC(2) = platmetaxGUI.APP(1,6,uidropdown(obj.app.maingrid,'BackgroundColor','w','Items',{},'ValueChangedFcn',@obj.cb_slider,'Visible','off'));
            obj.app.grid(3)  = platmetaxGUI.APP(2,[5 7],uigridlayout(obj.app.maingrid,'RowHeight',{'1x',40,30},'ColumnWidth',{20,150,'1x','1x',120,30,20},'Padding',[15 10 15 0],'RowSpacing',5,'BackgroundColor','w'));
            obj.app.axes     = platmetaxGUI.APP(1,[2 6],uiaxes(obj.app.grid(3),'BackgroundColor','w','Box','on'));
            obj.app.waittip  = platmetaxGUI.APP(1,[2 6],uilabel(obj.app.grid(3),'HorizontalAlignment','center','Text','                 Please wait ... ...','Visible','off'));
            ...
            obj.app.slider     = platmetaxGUI.APP(2,[1 7],uislider(obj.app.grid(3),'Limits',[0 1],'MajorTicks',0:0.25:1,'MajorTickLabels',{'0%','25%','50%','75%','100%'},'MinorTicks',0:0.01:1,'ValueChangedFcn',@obj.cb_slider));
            obj.app.labelC     = platmetaxGUI.APP(3,[1 2],uilabel(obj.app.grid(3),'Text','','HorizontalAlignment','left'));
            obj.app.buttonC(1) = platmetaxGUI.APP(3,3,uibutton(obj.app.grid(3),'push','Text','Start','FontSize',16,'ButtonpushedFcn',@obj.cb_start));
            obj.app.buttonC(2) = platmetaxGUI.APP(3,4,uibutton(obj.app.grid(3),'push','Text','Stop','FontSize',16,'Enable','off','ButtonpushedFcn',@(~,~)set(obj.app.buttonC(1:2),{'Enable','Text'},{true,'Start';false,'Stop'})));
            ...
            obj.app.menuC.flush();
            obj.app.buttonC(3) = platmetaxGUI.APP(3,[6 7],uibutton(obj.app.grid(3),'push','Text','Save','FontSize',16,'Enable','off','ButtonpushedFcn',@(~,~)obj.app.menuC.show()));
            
            % The fourth panel
            obj.app.grid(4)  = platmetaxGUI.APP(2,9,uigridlayout(obj.app.maingrid,'RowHeight',{22,22,'1x'},'ColumnWidth',{'1x','1x'},'Padding',[12 10 12 0],'RowSpacing',15,'BackgroundColor','w'));
            obj.app.dropD(1) = platmetaxGUI.APP(1,[1 2],uidropdown(obj.app.grid(4),'BackgroundColor','w','Items',{},'ItemsData',1:999,'ValueChangedFcn',@obj.cb_dropdown1));
            obj.app.dropD(2) = platmetaxGUI.APP(2,1,uidropdown(obj.app.grid(4),'BackgroundColor','w','Items',{},'ValueChangedFcn',@obj.cb_dropdown2));
            obj.app.dropD(3) = platmetaxGUI.APP(2,1,uidropdown(obj.app.grid(4),'BackgroundColor','w','Items',{},'ValueChangedFcn',@obj.cb_dropdown2,'Visible','off'));
            obj.app.labelD   = platmetaxGUI.APP(2,2,uilabel(obj.app.grid(4),'Text','','HorizontalAlignment','right'));
            obj.app.textD    = platmetaxGUI.APP(3,[1 2],uitextarea(obj.app.grid(4),'Editable','off'));
            
            % Initialization
            obj.cb_filter([],[],2);
            obj.app.listA(1).Value = 'NSGAII';
            obj.app.listA(2).Value = 'DTLZ2';
            platmetaxGUI.UpdateAlgProPara(obj.platmetaxGUI.app.figure,obj.app.listA(1),obj.app.listB,'BASEOPTIMIZER',1);
            platmetaxGUI.UpdateAlgProPara(obj.platmetaxGUI.app.figure,obj.app.listA(2),obj.app.listB,'PROBLEM',-1);
        end
    end
    methods(Access = private)
        ...
        function cb_start(obj,~,~)
            ...
            elseif strcmp(obj.app.buttonC(1).Text,'Continue')
                ...
                try
                    [name,para] = platmetaxGUI.GetParameterSetting(obj.app.listB.items(1));
                    ALG = feval(name,'parameter',para,'outputFcn',@obj.outputFcn,'save',20);
                    [name,para] = platmetaxGUI.GetParameterSetting(obj.app.listB.items(2));
