classdef DDPG_DE_Alpha2BBOBcons_Metaoptimizer < rl.agent.AbstractContinuousActionAgentMemoryTarget
    ...
    methods
        function this = DDPG_DE_Alpha2BBOBcons_Metaoptimizer(obsInfo, actInfo)
            % Constructor
            AgentType = "DDPG";
