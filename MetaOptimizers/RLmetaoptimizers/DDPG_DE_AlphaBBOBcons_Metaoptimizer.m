classdef DDPG_DE_AlphaBBOBcons_Metaoptimizer < rl.agent.AbstractContinuousActionAgentMemoryTarget
    ...
    methods
        function this = DDPG_DE_AlphaBBOBcons_Metaoptimizer(obsInfo, actInfo)
            % Constructor
            AgentType = "DDPG";
