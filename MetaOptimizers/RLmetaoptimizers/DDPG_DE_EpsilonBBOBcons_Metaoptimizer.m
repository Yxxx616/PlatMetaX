classdef DDPG_DE_EpsilonBBOBcons_Metaoptimizer < rl.agent.AbstractContinuousActionAgentMemoryTarget
    ...
    methods
        function this = DDPG_DE_EpsilonBBOBcons_Metaoptimizer(obsInfo, actInfo)
            % Constructor
            AgentType = "DDPG";
