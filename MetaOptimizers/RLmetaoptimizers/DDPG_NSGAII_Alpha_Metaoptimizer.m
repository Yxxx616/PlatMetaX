classdef DDPG_NSGAII_Alpha_Metaoptimizer < rl.agent.AbstractContinuousActionAgentMemoryTarget
    ...
    methods
        function this = DDPG_NSGAII_Alpha_Metaoptimizer(obsInfo, actInfo)
            % Constructor
            AgentType = "DDPG";
