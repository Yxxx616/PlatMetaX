...
% in the platform should acknowledge the use of "PlatMetaX" and reference 
% "Xu Yang, Rui Wang, et. al. PlatMetaX: An Integrated MATLAB platform for 
% Meta-Black-Box Optimization NIPs 2025".
%--------------------------------------------------------------------------
