...
# V1.0
- 实现了RL-,SL-,EC-based meta-optimizers
- GUI只能用于测试。
...
# PlatMetaX Copyright
Copyright (c) 2025 还没想好名字 Group. You are free to use the PlatMetaX for research purposes. All publications which use this platform or any code in the platform should acknowledge the use of "PlatMetaX" and reference "Xu Yang, and Rui Wang. PlatMetaX: A MATLAB platform for meta-black-box optimization [educational forum], *畅想一下NIPS, 2025, .(.): ..-..*".
